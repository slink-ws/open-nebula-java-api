...
public class VirtualRouterPool extends Pool implements Iterable<VirtualRouter>
{
    ...
    {
        return info(client, INFO_METHOD, filter, -1, -1);
    }
    ...
    {
        return infoAll(client, INFO_METHOD);
    }
    ...
    {
        return infoMine(client, INFO_METHOD);
    }
    ...
    {
        return infoGroup(client, INFO_METHOD);
    }
    ...
    {
        return info(client, INFO_METHOD, filter, startId, endId);
    }
